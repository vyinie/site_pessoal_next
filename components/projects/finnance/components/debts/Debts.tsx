'use client'
import DebtTab from "@/components/projects/finnance/components/debts/table/DebtTab";
import DebtsCard from "@/components/projects/finnance/components/debts/DebtsCard";
  ...
  return (
    <div className="template_dashboard flex flex-col items-center">
      <div className="mt-3 flex mobile:flex-col gap-5 justify-center items-center px-5">
        <DebtForm finnanceData={finnanceData} setFinnanceData={setFinnanceData}  />
