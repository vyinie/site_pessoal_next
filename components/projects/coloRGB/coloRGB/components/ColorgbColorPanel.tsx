...
export default function ColorsPanel({
  ...
  return (
    <div className={`${ezMode ?'w-[240px] grid-cols-2':'w-[360px] mobile-sm:w-[240px] mobile-sm:h-[360px] mobile-sm:grid-rows-3 mobile-sm:grid-cols-2 grid-cols-3'} grid  grid-rows-2  justify-self-start h-[240px] p-1 gap-1 border-2 border-neutral-400 rounded-md moblet:mt-12`}>
      {panelBlocks.map((i) => (
        <div
