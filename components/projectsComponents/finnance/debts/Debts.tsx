"use client";
import DebtTab from "@/components/projectsComponents/finnance/debts/table/DebtTab";
import DebtsCard from "@/components/projectsComponents/finnance/debts/DebtsCard";
